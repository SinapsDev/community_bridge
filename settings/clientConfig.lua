...
BridgeClientConfig.TargetResource    = ""           -- Only used when TargetSystem is not "auto". Set this to the resource name that actually provides the exports, for target systems that emulate another one under a different resource name (ex. "pa-target" exposing the qb-target api)
